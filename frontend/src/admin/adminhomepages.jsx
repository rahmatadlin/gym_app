...
const Adminhomepages = () => {
  return (
    <>
              ...
              <div className="flex items-center ms-3">
                ...
                >
                  ...
                  <ul className="py-1" role="none">
                    ...
                    <li><a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray300 dark:hover:bg-gray600 dark:hover:text-white" role="menuitem">Earnings</a></li>
                    <li><a href="#" className="block px-4 py-2 text-sm text-gray700 hover:bg-gray100 dark:text-gray300 dark:hover:bg-gray600 dark:hover:text-white" role="menuitem">Sign out</a></li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      {/* Sidebar */}
      <aside id="logo-sidebar" className={`fixed top-0 left-0 z-[40] w-[64] h-screen pt-[20] transition-transform -translate-x-full bg-white border-r border-gray200 sm:translate-x-[0] dark:bg-gray800 dark:border-gray700`} aria-label="Sidebar">
        <div className={`h-full px-[3] pb-[4] overflow-y-auto bg-white dark:bg-gray800`}>
          <ul className={`space-y-[2] font-medium`}>
            {/* Sidebar items */}
            <li><a href="#" className={`flex items-center p-[2] text-[#1f2937] rounded-lg dark:text-white hover:bg-[#f3f4f6] dark:hover:bg-[#374151] group`}><svg /* SVG content */ /><span className={`ms-[3]`}>Dashboard</span></a></li>
